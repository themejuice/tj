describe ThemeJuice::Tasks::Landrush do
  ...
  describe "#execute" do
    it "should append dns info to customfile" do
      ...
      expect(File.binread(@file)).to match /config\.landrush\.host 'graft.dev', '192.168.13.37'/
    end
  end
  ...
  describe "#unexecute" do
    it "should gsub dns info from customfile" do
      ...
      expect(File.binread(@file)).not_to match /config\.landrush\.host 'graft.dev', '192.168.13.37'/
