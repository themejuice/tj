...
Gem::Specification.new do |gem|
  ...
  gem.description    = %q{Theme Juice (tj) is a command line utility modern for WordPress development. It allows you to scaffold out a Vagrant development environment in seconds, and generate/manage an unlimited number of development projects. It also helps you manage dependencies and build tools, and can even handle your deployments.}
