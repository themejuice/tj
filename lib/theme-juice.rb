...
require "theme-juice/tasks/deploy/app"
...
require "theme-juice/tasks/deploy/settings"
require "theme-juice/tasks/deploy/load_capistrano"
require "theme-juice/tasks/deploy/invoke"
